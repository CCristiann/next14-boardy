import { Camera, Color, EllipseLayer, Layer, LayerType, PathLayer, Point, Side, XYWH } from "@/types/canvas"
...
export const isHittingRectangle = (layer: XYWH, point: Point) => {
  return (
    point.x > layer.x &&
...
export const isHittingEllipse = (layer: EllipseLayer, point: Point) => {
