...
import { colorToCss, connectionIdToColor, findIntersectingLayerWithPoint, findIntersectingLayersWithRectangle, penPointsToPathLayer, pointerEventToCanvasPoint, resizeBounds } from '@/lib/utils'
...
const Canvas = ({
    ...
    }, [resizeSelectedLayer, translateSelectedLayers, startMultiSelection, updateSelectionNet, continueDrawing, camera, canvasState])
